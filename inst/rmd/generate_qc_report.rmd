...
```{r mon_groupings_vs_reductions, class.source = 'fold-hide', fig.cap = "Plot of all Monocle3 dimensionality reductions, coloured by groupings"}
...
```{r, echo = FALSE, warning = F, message = F, results = 'asis'} 
plot_markers_on_object(object = cds, object_type = "Monocle3")
```
