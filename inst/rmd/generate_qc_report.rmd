...
# args <- dget("out/221202_A01366_0326_AHHTTWDMXY/hg38/SHE5052A9_S101/all-well/DGE_filtered/unintegrated/args_for_generate_qc_report.R") ; args$parse_dir <- "/Volumes/TracerX/working/VHL_GERMLINE/tidda/parse_pipeline/"
...
```{r detected_doublets_plot, eval = remove_doublets, echo = F, fig.cap = "Plot of detected doublets in each sample (using scDblFinder)"}
p_dat <- 
...
#### Renal lineage markers from Young et al., 2019 (PMC6104812)

The Young paper used markers from different renal developmental lineages to do an in-depth search for all resident celltypes. Authors curated markers from the literature for the following celltypes...

**`r paste(paste("*", names(literature_markers)), collapse = "\n")`** 

The present dataset will also be probed for evidence of these different celltypes.

```{r literature_markers}
