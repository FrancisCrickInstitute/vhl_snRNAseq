...
```{r summary_statistics_plot, echo = F, message = F, warning = F, fig.height = 15, fig.cap = "Plot of summary statistics by sample"}
p <-
...
```{r nonlin_dim_red_plot, echo = F, fig.width = 10, fig.cap = "Plot of UMAP and tSNE, coloured by sample"}
p <-
...
```{r groupings_vs_reductions, echo = F, fig.dim = c(10, 30), fig.cap = "Plot of all reductions, coloured by groupings"}
# amend groupings
...
```{r singler_annots_delta, echo = F, warnings = F, message = F, fig.cap = "Delta distribution of celltype annotations from SingleR"}
p <-
...
```{r umap_vs_singler_annots, echo = F, fig.width = 10, fig.height = 5, fig.cap = "Plot of UMAP clusters, coloured by SingleR annotation and labelled by majority SingleR annotation per cluster"}
...
```{r singler_annots_alluvial, echo = F, fig.width = 10, fig.cap = "Alluvial plot of assignment paths of nuclei from samples to clusters to SingleR annotations"}
p <-
  seu@meta.data %>%
