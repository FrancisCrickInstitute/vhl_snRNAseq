...
#'
#' @param parse_dir Path to Parse Biosciences split-pipe `analysis/` subdirectory.
...
#' @export
generate_qc_report <-
  function(parse_dir = "/camp/project/tracerX/working/VHL_GERMLINE/tidda/parse_pipeline/analysis/",
           experiment = NULL,
           genome = "hg38",
           sublibrary = "comb",
  ...
  # testing: args  # args <- dget("out/221202_A01366_0326_AHHTTWDMXY/hg38/SHE5052A9_S101/all-well/DGE_filtered/unintegrated/args_for_generate_qc_report.R") ; args$parse_dir <- "/Volumes/TracerX/working/VHL_GERMLINE/tidda/parse_pipeline/analysis/"
  ...
  # testing: PDOs v2 # parse_dir = "/nemo/lab/turajlics/home/users/dengd/scRNA_seq/proj_PDOT_Parse/output/Parse_lib_1/";experiment = "";genome = "";sublibrary = "";max_percent_mito = 30;max_nCount_RNA = 30000;do_add_sample_metadata = F;do_add_summary_stats = T;out_dir = "out/PDOs/"
