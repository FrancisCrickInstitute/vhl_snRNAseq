...
top_markers_fix <- function(cds,
  ...
  # cds=curr_cds;group_cells_by="partition_lineage";genes_to_test_per_group=25;reduction_method="UMAP";marker_sig_test=T;reference_cells=NULL;speedglm
